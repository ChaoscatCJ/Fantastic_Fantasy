package net.ChaoscatCJ.FantasticFantasy;
...
class Fantastic_Fantasy {
    ...
    private void addCreative(BuildCreativeModeTabContentsEvent event) {
        if(event.getTabKey() == CreativeModTabs.INGREDIENTS) {
            event.accept(ModItems.SAR_METAL_INGOT);
            event.accept(ModItems.RAW_STAR_METAL);
        }
    }
    @SubscribeEvent
    private void serverStartUp(ServerStartingEvent event) {
